...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form" action="../Controller/ControllerInicial/dadoslogin.php" method="POST">
   ...
   ?>
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "preencha o campo  Usuário">
      ...
      unset ($_SESSION['validacao_login']);
          ...
          ?>
					...
					<div class="wrap-input100 validate-input m-b-50" data-validate="Preencha o campo Senha">
					...
					<ul class="login-more p-t-190">
						<li class="m-b-8">
							...
							<a href="../View/ViewInicial/esqueci_senha.php" class="txt2">
								usuario e/ou Senha?
							</a>
						</li>
						...
						<li>
							...
							<a href="../View/ViewInicial/cadastro.php" class="txt2">
								Cadastre-se
							</a>
						</li>
					</ul>
